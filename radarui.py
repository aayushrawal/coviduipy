...
class SerialThread(QtCore.QThread):
    ...
    def run(self):
        ...
        #record = False
        x4m200 = radaruidata.configure_x4m200(RadarPort, False, radaruidata.x4m200_par_settings)
        ...
        while True:
            if self._break:
                return
            recv = ["X4M200","RPM","0","State","0x00","LD","0"]
            radar_data = radaruidata.print_x4m200_messages(x4m200).split()
...
class MainWindow(QWidget):
    ...
    def initUI(self):
        ...
        self.Instructions.setText("Radar Test")
